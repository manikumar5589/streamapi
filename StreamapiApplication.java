...
public class StreamapiApplication {
	...
	static {
		...
		employees.add(
				new Employee("Mani", "Kumar", 5000.0, List.of("project 1","project 2"))
				
		);
		
		employees.add(
				new Employee("Navaya", "Sree", 5500.0, List.of("project 2","project 3"))
				
		);
		
		employees.add(
				new Employee("Sai", "Kalayan", 4000.0, List.of("project 1","project 4"))
				
		);
		
		employees.add(
				new Employee("Lohitha", "Manchikalapati", 6000.0, List.of("project 1","project 2"))
